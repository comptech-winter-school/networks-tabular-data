...
def run(dataset, config):
    ...
    with Timer() as training:
        if is_classification:
            ...
            loss_histiry, error_histiry = train_model(trainer, X_train, y_train, X_val, y_val, 
                                                      device)
        else:
            log.warning("Regression task is not implemented yet.")
    ...
    return result(output_file=config.output_predictions_file,
                  ...
                  raining_duration=training.duration)
...
def train_model(trainer, X_train, y_train, X_val, y_val, device):
